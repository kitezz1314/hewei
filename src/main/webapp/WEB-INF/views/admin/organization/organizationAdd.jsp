...
<div style="padding: 3px;">
    <form id="organizationAddForm" method="post">
        <table class="grid">
            <tr>
                <td>编号</td>
                <td><input name="code" type="text" placeholder="请输入网点编号" class="easyui-validatebox" data-options="required:true" ></td>
                <td>组织名称</td>
                <td><input name="name" type="text" placeholder="请输入网点名称" class="easyui-validatebox" data-options="required:true" ></td>
            ...
            <tr>
                <td>上级组织</td>
                <td colspan="3"><select id="organizationAddPid" name="pid" style="width:225px;overflow-y:100px;"></select>
