...
public class MainMenu {
	...
	private Menu getMenu() {
		...
		tSubMenuButton_oneone.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx17717cc913f8ddc7&redirect_uri=http://aftersale.hewei.com/wechat/addPage&response_type=code&scope=snsapi_base&state=123#wechat_redirect");
		...
		tSubMenuButton_onethree.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx17717cc913f8ddc7&redirect_uri=http://aftersale.hewei.com/wechat/problemPreview&response_type=code&scope=snsapi_base&state=123#wechat_redirect");
		...
		tSubMenuButton_twothree.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx17717cc913f8ddc7&redirect_uri=http://aftersale.hewei.com/wechat/problemsList&response_type=code&scope=snsapi_base&state=123#wechat_redirect");
		...
		tSubMenuButton_threethree.setUrl("http://mail.hewei.com/");
		...
		tSubMenuButton_threefour.setUrl("http://aftersale.hewei.com/login");
		// 加入导航菜单
