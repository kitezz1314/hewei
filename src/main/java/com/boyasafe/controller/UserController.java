...
import com.boyasafe.commons.shiro.PasswordHash;
import com.boyasafe.commons.utils.StringUtils;
import com.boyasafe.model.Role;
...
public class UserController extends BaseController {
    ...
    public String editPage(Model model, Long id) {
        ...
        for (Role role : rolesList) {
            //ids.add(role.getId());
        	sBuffer.append(role.getId().toString());
        	sBuffer.append(",");
        }
        String roleids = sBuffer.toString();
    ...
    public String combobox() {
    	List<User> users = userService.selectCombobox();
