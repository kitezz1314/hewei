...
import com.boyasafe.commons.utils.BeanUtils;
import com.boyasafe.commons.utils.StringUtils;
import com.boyasafe.mapper.UserMapper;
...
import com.boyasafe.service.IUserService;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
	...
	@Override
	public Map<String, Object> selectUserByCode(String code) {
		// TODO Auto-generated method stub
		return userMapper.selectUserByCode(code);
	}
	
	@Override
	public List<User> selectCombobox() {
		// TODO Auto-generated method stub
		return userMapper.selectCombobox();
	}

	@Override
	public User selectUserByLoginName(String code) {
		// TODO Auto-generated method stub
		return userMapper.selectUserByLoginName(code);
	}
