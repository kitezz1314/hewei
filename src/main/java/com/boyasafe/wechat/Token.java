...
import com.boyasafe.mapper.TokenMapper;
import com.boyasafe.mybatis.BaseMapperTest;

public class Token {
	public com.boyasafe.model.Token geToken() throws Exception{
		...
		com.boyasafe.model.Token tokenlocal = tokenMapper.selectById(1l);
