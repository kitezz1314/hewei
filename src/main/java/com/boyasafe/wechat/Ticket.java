...
import com.boyasafe.mapper.TicketMapper;
import com.boyasafe.mybatis.BaseMapperTest;

public class Ticket {
	public com.boyasafe.model.Ticket getTicket() throws Exception{
		...
		com.boyasafe.model.Ticket ticketlocal = ticketMapper.selectById(1l);
		Date currentTime = new Date();
		if ((currentTime.getTime()-ticketlocal.getExpiresIn()*1000)<ticketlocal.getCreatetime().getTime()) {
			return ticketlocal;
		}else{
			Token token = new Token();
			com.boyasafe.model.Token tokenlocal = token.geToken();
