package com.boyasafe.generator;
...
public class MysqlGenerator {
	...
	public static void main(String[] args) {
		...
		String outputDir = "E://mybatisplus";
...
//		strategy.setTablePrefix(new String[] { "bmd_", "mp_" });// 此处可以修改为您的表前缀
		...
		strategy.setInclude(new String[] { "malfunction" }); // 需要生成的表
		...
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.boyasafe.commons.base.BaseController");
		...
		pc.setParent("com.boyasafe"); // 自定义包路径
